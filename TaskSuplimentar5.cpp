...
//		}
//	}
//	friend ostream& operator<<(ostream& out, Smartphone s) {
//		out << "Marca: " << s.marca << endl;
//		out << "An fabricatie: " << s.anFabricatie << endl;
//		out << "Numar preturi: " << s.nrPreturi << endl;
//		if (s.preturi != NULL) {
...
//	}
//
//	friend istream& operator>>(istream& in, Smartphone& s) {
//		cout << "Marca: ";
//		in >> s.marca;
//
//		cout << "Numar preturi: ";
...
//		}
//
//		s.preturi = new float[s.nrPreturi];
//		for (int i = 0; i < s.nrPreturi; i++) {
//			cout << "Pret " << i + 1 << ": ";
//			in >> s.preturi[i];
//		}
...
//		out << "Cod unic: " << c.CODUnic << endl;
//		out << "Memorie totala: " << c.memorieTotala << endl;
//		out << "Nr aplicatii: " << c.nrAplicatiiInstalate << endl;
//		return out;
//	}
//
...
//
//		cout << "Nr aplicatii: ";
//		in >> c.nrAplicatiiInstalate;
//
//		if (c.memorieOcupata != NULL) {
//			delete[] c.memorieOcupata;
//		}
//
//		c.memorieOcupata = new float[c.nrAplicatiiInstalate];
//		for (int i = 0; i < c.nrAplicatiiInstalate; i++) {
//			cout << "Memorie aplicatie " << i + 1 << ": ";
//			in >> c.memorieOcupata[i];
//		}
//
//		return in;
//	}
...
//
//	//Operatorul >>
//	friend istream& operator>>(istream& in, Smartwatch& obj) {
//		cout << "Nume posesor: ";
//		in >> obj.numePosesor;
//		cout << "Culoare: ";
//		in >> obj.culoare;
//		cout << "Are GPS (1-Da, 0-Nu): ";
//		in >> obj.areGps;
//		if (obj.producator != NULL) {
//			delete[] obj.producator;
//		}
//		char buffer[100];
//		cout << "Producator: ";
//		in >> buffer;
//		obj.producator = new char[strlen(buffer) + 1];
//		strcpy(obj.producator, buffer);
//		return in;
//	}
//
//};
...
//	MagazinElectronice() {
//		this->numeMagazin = "Necunoscut";
//		this->oras = "Necunoscut";
//		this->nrSmartphoneuri = 0;
//		this->smartphoneuri = NULL;
//		nrMagazine++;
//	}
//
//	// Constructor cu 2 parametri
//	MagazinElectronice(string numeMagazin, string oras) {
...
//
//	// Constructor cu toti parametrii
//	MagazinElectronice(string numeMagazin, string oras, int nrSmartphoneuri, Smartphone* smartphoneuri) {
//		this->numeMagazin = numeMagazin;
//		this->oras = oras;
//		this->nrSmartphoneuri = nrSmartphoneuri;
//		this->smartphoneuri = new Smartphone[nrSmartphoneuri];
//		for (int i = 0; i < nrSmartphoneuri; i++) {
//			this->smartphoneuri[i] = smartphoneuri[i];
//		}
//		nrMagazine++;
//	}
//
//	// Destructor
//	~MagazinElectronice() {
//		if (smartphoneuri != NULL) {
//			delete[] smartphoneuri;
//		}
//	}
//
//	// Constructor de copiere
//	MagazinElectronice(const MagazinElectronice& m) {
//		this->numeMagazin = m.numeMagazin;
//		this->oras = m.oras;
//		this->nrSmartphoneuri = m.nrSmartphoneuri;
//		this->smartphoneuri = new Smartphone[m.nrSmartphoneuri];
//		for (int i = 0; i < m.nrSmartphoneuri; i++) {
//			this->smartphoneuri[i] = m.smartphoneuri[i];
//		}
//		nrMagazine++;
//	}
//
...
//	}
//
//	int getNrSmartphoneuri() {
//		return this->nrSmartphoneuri;
//	}
//
//	Smartphone* getSmartphoneuri() {
//		return this->smartphoneuri;
//	}
//
//	// Setteri
...
//	}
//
//	void setSmartphoneuri(int nrSmartphoneuri, Smartphone* smartphoneuri) {
//		if (this->smartphoneuri != NULL) {
//			delete[] this->smartphoneuri;
//		}
//		this->nrSmartphoneuri = nrSmartphoneuri;
//		this->smartphoneuri = new Smartphone[nrSmartphoneuri];
//		for (int i = 0; i < nrSmartphoneuri; i++) {
...
//
//	// Operator += 
//	MagazinElectronice& operator+=(Smartphone s) {
//		Smartphone* copie = new Smartphone[this->nrSmartphoneuri + 1];
//
//		for (int i = 0; i < this->nrSmartphoneuri; i++) {
//			copie[i] = this->smartphoneuri[i];
//		}
//
//		copie[this->nrSmartphoneuri] = s;
//
//		if (this->smartphoneuri != NULL) {
//			delete[] this->smartphoneuri;
//		}
//
//		this->nrSmartphoneuri++;
//		this->smartphoneuri = copie;
//
//		return *this;
//	}
//
//	// Operator <<
//	friend ostream& operator<<(ostream& out, MagazinElectronice m) {
//		out << "Magazin: " << m.numeMagazin << endl;
//		out << "Oras: " << m.oras << endl;
//		out << "Numar smartphone-uri: " << m.nrSmartphoneuri << endl;
//		for (int i = 0; i < m.nrSmartphoneuri; i++) {
//			out << "Smartphone " << i + 1 << ":" << endl;
//			out << m.smartphoneuri[i] << endl;
//		}
//		return out;
//	}
//
//	static void afisareNrMagazine() {
//		cout << "Numar magazine create: " << nrMagazine << endl;
//	}
//};
//
//int MagazinElectronice::nrMagazine = 0;
//
//
//
...
//	cout << sw4 << endl << endl;
//
//	cout << "--------------------------------VECTOR SMARTPHONE -------------------------" << endl << endl;
//
//	int n;
//	//cout << "Numar smartphone-uri: ";
//	//cin >> n;
//
//	Smartphone* vSmartphone = new Smartphone[n];
//
//	for (int i = 0; i < n; i++) {
//		cin >> vSmartphone[i];
//	}
...
//	//cin >> m;
//
//	Calculator* vCalculator = new Calculator[m];
//
//	for (int i = 0; i < m; i++) {
//		cin >> vCalculator[i];
//	}
//
//	for (int i = 0; i < m; i++) {
//		cout << vCalculator[i] << endl;
//	}
//
//
//
//	cout << "--------------------------------VECTOR SMARTWATCH -------------------------" << endl << endl;
//
//	int k;
//	//cout << "Numar smartwatch-uri: ";
//	//cin >> k;
//
//	Smartwatch* vSmartwatch = new Smartwatch[k];
//
//	for (int i = 0; i < k; i++) {
//		cin >> vSmartwatch[i];
//	}
//
//	for (int i = 0; i < k; i++) {
//		cout << vSmartwatch[i] << endl;
//	}
//
//	cout << "--------------------------------MATRICE smartwatch-------------------------" << endl << endl;
//	cout << "===== MATRICE SMARTWATCH =====" << endl;
//
//	int linii, coloane;
//	//cout << "Linii: ";
//	//cin >> linii;
...
//	//cin >> coloane;
//
//	Smartwatch** matrice = new Smartwatch * [linii];
//	for (int i = 0; i < linii; i++) {
//		matrice[i] = new Smartwatch[coloane];
//	}
//
//	for (int i = 0; i < linii; i++) {
...
//	delete[] matrice;
//
//	cout << "--------------------------------Relatie HAS A-------------------------" << endl << endl;
//
//	Smartphone lista[2];
//	cin >> lista[0];
//	cin >> lista[1];
//
//	MagazinElectronice m1("Altex", "Bucuresti", 2, lista);
//	cout << m1 << endl;
//
//	Smartphone sNou;
//	cin >> sNou;
//	m1 += sNou;
//
//	cout << "Dupa adaugare smartphone:" << endl;
//	cout << m1 << endl;
//
//	MagazinElectronice::afisareNrMagazine();
//
//
//}
//
